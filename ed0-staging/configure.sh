...
export INSTANCE=app-practable-io-alpha-ed0-staging

# Health check info (There is no healthcheck set up for the staging environment)
export BACKEND_SERVICE=ci-https-redirect-backend-ed0-staging

# Networking info for services & ansible nginx conf
export INSTANCE_PATH=ed0-staging
...
export ANSIBLE_GROUP=app_practable_ed0_staging
