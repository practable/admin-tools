...
export HTTPS_HOST="https://${DOMAIN}/${PATH}"
export WSS_HOST="wss://${DOMAIN}/${PATH}"
...
envsubst '${ANSIBLE_GROUP} ${DOMAIN} ${EMAIL}' < ./templates/install-nginx.yml.template > ./playbooks/install-nginx.yml
...
envsubst '${ANSIBLE_GROUP}' < ./templates/playbook-update-ngxin-conf.yml.template > ./playbooks/update-nginx-conf.yml
