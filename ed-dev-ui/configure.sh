...
envsubst '${DOMAIN}  ${INSTANCE_PATH} ${DAVID_STATIC_REPO_NAME} ${DAVID_STATIC_REPO_URL} ${DAVID_STATIC_SUB_DIRS} ${SIJIE_STATIC_REPO_NAME} ${SIJIE_STATIC_REPO_URL} ${SIJIE_STATIC_SUB_DIRS}' < ./templates/vars.yml.template > ./autogenerated/vars.yml
